...
class Helper_FileSize {
	...
	*/
	public function fileSize(Model_File $file, $class = "small") {
//	    $fbytes = filesize(APPLICATION_PATH. "/../public/files/" . $file->filename);
	    $res = ($file->filesize)/1024/1000;
	    return "<span class='".$class."'>".round($res, 1)."Мб</span>";
	}
