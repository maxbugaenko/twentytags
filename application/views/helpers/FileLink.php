...
class Helper_FileLink {
	...
	*/
	public function fileLink(Model_File $file, $url, $lab) {
	    return "<a class='menu' title=\"скачать ".$file->filename." (".$file->description.")\" href=\"".$url."\">".$lab."</a>";
//	    return "<span style='color:#268af0'>".$user->nickname."</span>";
	}
