...
class Helper_FavLink {
	...
	*/
	public function favLink(Model_Entity $entity, $item, $class = "button-small") {
//	    return "<a id=\"add{$entity}\" class=\"menu-s\" onclick=\"makeFavorite({$entity})\"  title=\""._t('I recommend this!')."\">"._t('I recommend this')."</a><br/>";
	    return "<input id=\"add{$item}\" type=\"button\" class=\"{$class}\" style=\"margin-top:2px;margin-bottom:2px;\" onclick=\"makeFavorite({$entity}, {$item})\"  value=\"рекомендую\"/>";
	}
