...
class Helper_EntityDetails {
	...
	*/
	public function entityDetails(Model_Entity $entity, $class = "small") {
	    $code = "<div class='{$class}'>";
        $commentCount = Model_Opinion::getCountByEntity($entity);
        if ($commentCount > 0)
            $code .= "мнения: ".$commentCount."<br/>";
        $code .= "файлы: ".count($files = Model_File::retrieveByEntity($entity))."</div>";
	    return $code;
	}
