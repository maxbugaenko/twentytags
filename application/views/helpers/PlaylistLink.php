...
class Helper_PlaylistLink {
	...
	*/
	public function playlistLink(Model_File $file, $class = "button-small") {
	    return "<input id=\"pl{$file}\" type=\"button\" class=\"{$class}\" style=\"margin-top:2px;margin-bottom:2px;\" onclick=\"addToPlaylist({$file})\"  value=\"отложить\"/>";
	}
